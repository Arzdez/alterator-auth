    ...
    (document:id ad-group-type (radio name "auth_type" value "ad" text (_ "Active Directory domain")))
      ...
      (document:id ad-group (gridbox columns "0;0;50;50" spacing 5
        ...
        (document:id type-ad-warning (gridbox colspan 4 columns "0;100" visibility #f (label text "   ") (label
            text (string-append (bold (_ "Warning: ")) (_ "Package task-auth-ad-sssd or task-auth-ad-winbind is not installed. Authentication with Active Directory is not available.")))))
